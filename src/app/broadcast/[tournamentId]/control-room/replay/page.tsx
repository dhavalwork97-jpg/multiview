...
function Field({ label, value, onChange, placeholder, type = "text" }: { label: string; value: string; onChange: (value: string) => void; placeholder?: string; type?: string }) { return <label style={styles.smallLabel}>{label}<input value={value} type={type} placeholder={placeholder} onChange={(event) => onChange(event.target.value)} style={styles.input} /></label>; }

const styles: Record<string, CSSProperties> = { main: { minHeight: "100vh", background: "#07080d", color: "#f7f8ff", padding: 28, fontFamily: "Inter, system-ui, sans-serif" }, container: { maxWidth: 1200, margin: "0 auto" }, header: { display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 20, marginBottom: 24 }, eyebrow: { fontSize: 10, letterSpacing: ".18em", opacity: .45 }, title: { fontSize: 34, margin: "7px 0 0" }, sectionTitle: { fontSize: 18, margin: "6px 0 0" }, muted: { fontSize: 11, opacity: .5, marginTop: 5 }, link: { color: "#c4b5fd", textDecoration: "none", fontSize: 11, letterSpacing: ".12em" }, grid: { display: "grid", gridTemplateColumns: "1.35fr .65fr", gap: 18 }, panel: { background: "#0c0e14", border: "1px solid #252936", borderRadius: 20, padding: 20 }, rowHeader: { display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 18 }, status: { fontSize: 9, letterSpacing: ".14em", color: "#c4b5fd" }, list: { display: "grid", gap: 9, marginTop: 15 }, item: { display: "flex", alignItems: "center", gap: 10, padding: 12, borderRadius: 12, background: "#10131b", border: "1px solid #252936" }, selectButton: { flex: 1, textAlign: "left", border: 0, background: "transparent", color: "white", fontWeight: 800, cursor: "pointer" }, meta: { fontSize: 10, opacity: .45, minWidth: 45, textAlign: "center" }, secondary: { border: "1px solid #2b2f3c", borderRadius: 8, background: "#11131a", color: "white", padding: "8px 10px", fontWeight: 700, cursor: "pointer" }, danger: { border: "1px solid #4a2931", borderRadius: 8, background: "#171015", color: "#fda4af", padding: "8px 10px", fontWeight: 700, cursor: "pointer" }, empty: { border: "1px dashed #303441", borderRadius: 12, padding: 22, textAlign: "center", opacity: .55, fontSize: 12 }, primary: { border: "1px solid #3b2a67", borderRadius: 9, background: "#7c3aed", color: "white", padding: "11px 14px", fontWeight: 800, cursor: "pointer", width: "100%", marginTop: 10 }, secondaryWide: { border: "1px solid #2b2f3c", borderRadius: 8, background: "#11131a", color: "white", padding: "8px 10px", fontWeight: 700, cursor: "pointer", width: "100%", marginTop: 10 }, monitor: { minHeight: 280, marginTop: 14, borderRadius: 14, background: "#08090e", border: "1px solid #2b2f3c", position: "relative", overflow: "hidden" }, thumb: { width: "100%", height: "100%", minHeight: 280, objectFit: "cover", opacity: .7 }, monitorFallback: { minHeight: 280, display: "grid", placeItems: "center", fontSize: 34, fontWeight: 900, letterSpacing: ".08em", opacity: .25 }, progressWrap: { position: "absolute", left: 16, right: 16, bottom: 14 }, progressMeta: { display: "flex", justifyContent: "space-between", fontSize: 10, opacity: .65 }, track: { height: 4, borderRadius: 99, background: "#292d38", marginTop: 6, overflow: "hidden" }, fill: { height: "100%", borderRadius: 99, background: "#8b5cf6" }, threeCol: { display: "grid", gridTemplateColumns: "1.2fr .7fr .7fr", gap: 12, marginTop: 14 }, fourCol: { display: "grid", gridTemplateColumns: "1fr 1.4fr 1.4fr .7fr", gap: 10, marginTop: 14 }, addRow: { display: "grid", gridTemplateColumns: "1fr 1fr auto", gap: 10, marginTop: 10, alignItems: "flex-end" }, smallLabel: { fontSize: 10, letterSpacing: ".12em", opacity: .65, display: "block" }, input: { width: "100%", marginTop: 7, border: "1px solid #2b2f3c", borderRadius: 9, background: "#080a10", color: "white", padding: "9px 10px", boxSizing: "border-box" }, checkbox: { display: "block", marginTop: 10 } };