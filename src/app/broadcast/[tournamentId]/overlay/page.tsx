...
function parseKind(value: string | null): BroadcastOverlayKind {
  return value && KINDS.includes(value as BroadcastOverlayKind) ? (value as BroadcastOverlayKind) : "program";
}
...
export default function BroadcastOverlayPage({ params }: { params: Promise<{ tournamentId: string }> }) {
  ...
  useEffect(() => {
    ...
    void params.then(({ tournamentId: id }) => {
      ...
      setTournamentId(id);
      setKind(parseKind(search.get("kind")));
