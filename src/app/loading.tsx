export default function Loading() {
  return (
    <main className="page-shell" aria-busy="true" aria-label="Loading">
      <div className="page-container">
        <section className="surface-card p-6 sm:p-10">
          <div className="h-3 w-24 animate-pulse rounded bg-arena-700" />
          <div className="mt-4 h-10 max-w-xl animate-pulse rounded bg-arena-800" />
          ...
          <p className="sr-only">Loading competition data…</p>
        </section>
      </div>
    </main>
  );
