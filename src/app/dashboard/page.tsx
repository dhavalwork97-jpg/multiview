...
export default async function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-arena-950 px-6 py-8">
      ...
      <section className="mb-10 rounded-card border border-arena-700 bg-arena-900 p-4">
        <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
          <div>
            <p className="font-mono text-[10px] uppercase tracking-widest text-signal-live">Competition workspace</p>
            <h2 className="mt-1 font-display text-xl uppercase tracking-wide">All tools</h2>
          </div>
          {canCreateTournament && <Link href="/admin/tournaments/new" className="action-primary">Create tournament</Link>}
        </div>
